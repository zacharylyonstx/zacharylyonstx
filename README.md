...
|------|-------------|--------|
| **[cursorrules](https://github.com/zacharylyonstx/cursorrules)** | Generate `.cursorrules` for Cursor AI — 24 presets | `npx cursorrules init` |
| **[ai-commit-offline](https://github.com/zacharylyonstx/ai-commit-offline)** | Smart git commit messages, completely offline | `npx ai-commit-offline` |
