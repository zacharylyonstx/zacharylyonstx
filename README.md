...
|------|-------------|--------|
| **[project-init](https://github.com/zacharylyonstx/project-init)** | 🆕 Initialize any project in 60 seconds | `npx project-init-ai` |
| **[cursorrules](https://github.com/zacharylyonstx/cursorrules)** | Generate `.cursorrules` for Cursor AI | `npx cursorrules init` |
| **[ai-commit-offline](https://github.com/zacharylyonstx/ai-commit-offline)** | Smart git commit messages, offline | `npx ai-commit-offline` |
...
| **[env-audit](https://github.com/zacharylyonstx/env-audit)** | Audit env vars + find secrets | `npx env-audit` |
